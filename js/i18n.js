...
const UI_TEXT = {
  en: {
    ...
    progress: "Progress",
    savedAtEnd: "Your answers are saved on this browser and submitted at the end.",
  ...
  fr: {
    ...
    savedAtEnd: "Vos réponses sont enregistrées dans ce navigateur et envoyées à la fin.",
